...
export default class TopicSelectionWithoutPicker extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            username:"",
    ...
    onSubmit = async () => {
        ...
        // }else{
            ...
            // console.log(states[usState].name, "Name")
            // console.log(states[usState].abbreviation, "Abbreviation")
            if(this.state.checkbox1 == false && this.state.checkbox2 ==false && this.state.checkbox3 ==false && this.state.checkbox4 ==false && this.state.checkbox5 ==false && this.state.checkbox6 ==false && this.state.checkbox7 ==false && this.state.checkbox8 ==false && this.state.checkbox9 ==false && this.state.checkbox10 ==false && this.state.checkbox11 ==false &&
                ...
                Alert.alert(
                    ...
                    [
                        {text: 'OK', onPress: () => this.props.navigation.navigate("TopicSelectionWithoutPicker")}
                    ]
                )
            }else{  
                ...
                this.props.navigation.navigate("CandidateSelection")
            }
        }
