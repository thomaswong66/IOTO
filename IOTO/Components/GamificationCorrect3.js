...
export default class GamificationCorrect extends Component {
    constructor(props) {
        super(props);
        this.state = { 
    ...
    render() {
        return(
            <View>
            <ImageBackground style={{width:'100%', height:'100%'}} source={require('../assets/worldmap.jpg')} blurRadius={10}>
                <View style={styles.topContainer}>
                    <Text style={{fontSize:40, color:'limegreen'}}>Correct!</Text>
                    <Text style={{fontSize:20,marginLeft:30,marginRight:20,color:'white',lineHeight:30}}>{"\n"}Denmark has visa-free access 187 countries, ranking 5th in terms of travel freedom; while The United States has 184 countries, ranking at the 8th. The 1st of travel freedom country is Japan, it has 191 visa-free countries.</Text>
                </View>
                <View style={styles.middleContainer}>
                    <TouchableOpacity style={styles.next} onPress={() => this.props.navigation.navigate("Leaderboard")}>
                        <Text style={styles.textstyle}>View Scores</Text>
                    </TouchableOpacity>
                </View>
