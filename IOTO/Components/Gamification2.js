...
export default class Gamification extends Component {
    ...
    rightAnswer() {
        Alert.alert(
            'Correct!',
            'Lima is the correct answer',
            [
                {text: 'OK', onPress: () => this.props.navigation.navigate("Leaderboard")}
            ]
        )
    }
    ...
    wrongAnswer() {
        Alert.alert(
            ...
            'Try Again!',
            [
                {text: 'OK', onPress: () => this.props.navigation.navigate("Gamification2")}
            ]
        )
    }
        ...
        return(
            <View style={styles.container}>
                    <View style={styles.TopContainer}>
                        <ImageBackground style={{width:'100%', height:'100%'}} source={require('../assets/environment.jpg')} blurRadius={10}>
                            <View style={{justifyContent: 'center', textAlign: 'center'}}>
                                <Text style={{textAlign: 'center', color:'black', fontSize:30,}}>{"\n"}Environment{"\n"}</Text>
                                <Text style={styles.textstyle}>Which is the law that prohibits dumping wastes into the ocean and punishes people who dump wastes?</Text>
                            </View>
                        </ImageBackground>
                    </View>
                <View style={styles.MiddleContainer}>
                    <TouchableOpacity style={styles.answerOption1} onPress={this.wrongAnswer}>
                        <Text style={styles.textstyleAnswer}>Green Tax</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.answerOption2} onPress={this.wrongAnswer}>
                        <Text style={styles.textstyleAnswer}>Cap and Trade</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.answerOption3} onPress={() => this.props.navigation.navigate("GamificationCorrect2")}>
                        <Text style={styles.textstyleAnswer}>Command and Control</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.answerOption4} onPress={this.wrongAnswer}>
                        <Text style={styles.textstyleAnswer}>Subsidy</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.container}>
