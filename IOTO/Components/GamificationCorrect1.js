...
export default class GamificationCorrect1 extends Component {
    constructor(props) {
        super(props);
        this.state = { 
    ...
    render() {
        return(
            <View>
                <ImageBackground style={{width:'100%', height:'80%'}} source={require('../assets/DoDBudget.jpg')}>
                ...
                <View style={styles.middleContainer}>
                    <TouchableOpacity style={styles.next} onPress={() => this.props.navigation.navigate("Gamification2")}>
