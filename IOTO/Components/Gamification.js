...
export default class Gamification extends Component {
    ...
    rightAnswer() {
        Alert.alert(
            'Correct!',
            '$633.3B is the correct answer',
            [
                {text: 'OK', onPress: () => this.props.navigation.navigate("GamificationCorrect1")}
            ]
        )
    }
    ...
    wrongAnswer() {
        Alert.alert(
            ...
            'Try Again!',
            [
                {text: 'OK', onPress: () => this.props.navigation.navigate("Gamification")}
            ]
        )
    }
        ...
        return(
            <View style={styles.container}>
                    <View style={styles.TopContainer}>
                        <ImageBackground style={{width:'100%', height:'100%'}} source={require('../assets/DoD.png')} blurRadius={5}>
                            <View style={{justifyContent: 'center', textAlign: 'center'}}>
                                <Text style={{textAlign: 'center', color:'black', fontSize:30,}}>{"\n"}Defence{"\n"}</Text>
                                <Text style={styles.textstyle}>In 2020 what was the total base budget for the Department of Defence?</Text>
                            </View>
                        </ImageBackground>
                    </View>
                <View style={styles.MiddleContainer}>
                    <TouchableOpacity style={styles.answerOption1} onPress={this.rightAnswer}>
                        <Text style={styles.textstyle}>$633.3B</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.answerOption2} onPress={this.wrongAnswer}>
                        <Text style={styles.textstyle}>$71.3B</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.answerOption3} onPress={this.wrongAnswer}>
                        <Text style={styles.textstyle}>$521.7B</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.answerOption4} onPress={this.wrongAnswer}>
                        <Text style={styles.textstyle}>$364.9B</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.container}>
